...
if args.dataset != 'none':
    ...
    args.pic_train_file = os.path.join(root_path, 'benchmark', args.dataset, 'bup/train')
    args.pic_val_file = os.path.join(root_path, 'benchmark', args.dataset, 'bup/val')
    args.pic_test_file = os.path.join(root_path, 'benchmark', args.dataset, 'bup/test')
